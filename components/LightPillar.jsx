    ...
    `;
        ...
        const material = new THREE.ShaderMaterial({
            ...
            uniforms: {
                ...
                uPillarWidth: { value: width < 768 ? pillarWidth * 4.0 : pillarWidth }, // Aggressively expand on mobile
        ...
        const handleResize = () => {
            ...
            resizeTimeout = window.setTimeout(() => {
                ...
                // Update pillar width based on new screen size
                const isMobile = newWidth < 768;
                materialRef.current.uniforms.uPillarWidth.value = isMobile ? pillarWidth * 4.0 : pillarWidth;
            }, 150);
        };
